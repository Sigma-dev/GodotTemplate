...
func _enter_tree():
	...
	add_custom_type("OnceParticles3D", "CPUParticles3D", preload("OnceParticles3D/OnceParticles3D.gd"), preload("OnceParticles3D/OnceParticles3DIcon.png"))
...
func _exit_tree():
	...
	remove_custom_type("OnceParticles3D")
